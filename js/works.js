    ...
    var PROJECTS = [
      { 
        ...
        year: '2026', 
        tags: ['Chrome Extension API', 'TensorFlow.js', 'React'], 
        link: 'https://github.com/flynnmaxweld/void-ai-workspace-manager.git',
        cover: 'assets/images/projects/Covers/1.jpg' 
      },
      { 
        id: 'aris', 
        title: 'A.R.I.S.', 
        ...
        year: '2026', 
        tags: ['Python', 'OpenAI API', 'HuggingFace'], 
        cover: 'assets/images/projects/Covers/2.jpg' 
      },
      { 
        ...
        year: '2026', 
        tags: ['Python', 'Watchdog Daemon', 'PyExifTool'], 
        link: 'https://github.com/flynnmaxweld/smart-file-organizer.git',
        cover: 'assets/images/projects/Covers/3.jpg' 
      }
    ];
        ...
        '<div class="face-content ' + (isLeft ? 'layout-left' : 'layout-right') + '">' +
          ...
          '<div class="face-info">' +
            ...
            '<div class="face-info-content">' +
              ...
              '<div class="face-tags">' + proj.tags.map(function(t) { return '<span class="face-tag">' + t + '</span>'; }).join('') + (proj.link ? '<a class="face-tag face-github-btn" href="' + proj.link + '" target="_blank" rel="noopener noreferrer" style="background:#ff3b14;color:#ffffff;font-weight:bold;text-decoration:none;display:inline-flex;align-items:center;gap:0.3rem;">GitHub Repo 🡺</a>' : '') + '</div>' +
            '</div>' +
          '</div>' +
        '</div>';
    }

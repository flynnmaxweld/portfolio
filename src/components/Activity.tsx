...
export default function Activity() {
  ...
  const { weeks, totalContributions, monthLabels } = useMemo(() => {
    ...
    for (let i = 363; i >= 0; i--) {
      ...
      // Pseudo-deterministic contribution calculation based on date hash
      ...
      <div className="activity-inner">
        ...
        <Reveal>
          <div className="activity-header">
            <span className="activity-kicker">ENGINEERING DISCIPLINE</span>
            <h2 className="activity-headline">
              Commit rhythm &amp; <em>activity.</em>
            </h2>
          ...
          <div className="activity-card">
            ...
            <div className="activity-card-top">
              ...
              {hoveredDay ? (
                ...
                <span className="activity-tooltip-text quiet">Hover cells to inspect daily commits</span>
              )}
            </div>

            {/* Custom SVG Heatmap Grid */}
